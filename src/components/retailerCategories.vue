...
import { useRoute, useRouter } from 'vue-router';
    ...
    const showProducts = async(category)=>{
        console.log("hello");
        localStorage.setItem('retailerSelectedProductCategory', category);
        if(routePath.path==='/retailer/homepage'){
            router.push('/retailer/category/products/page');
        }
    }
...
<template>
    <div class="categories">
        ...
        <div class="categories-cont">
            <div class="categories-box" @click="showProducts(DairyItems)">
...
const showProducts = async (category) => {
  ...
  localStorage.setItem('retailerSelectedProductCategory', category);
    console.log(localStorage.getItem('retailerSelectedProductCategory'))
