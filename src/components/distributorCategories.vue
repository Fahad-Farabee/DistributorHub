...
const showProducts = async (category) => {
  ...
  localStorage.setItem('distributorSelectedProductCategory', category);
    console.log(localStorage.getItem('distributorSelectedProductCategory'))
  // Navigate to the products page
  if (routePath.path === '/distributor/homepage') {
    router.push('/distributor/category/products/page');
  }
};
</script>
